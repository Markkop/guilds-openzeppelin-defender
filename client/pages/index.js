...
export default class App extends React.Component {
  ...
  executeMint = async (hash, signature) => {
    ...
    try {
      const address = await (this.state.provider.getSigner()).getAddress();
      const tx = await nftContract.safeMint(address, hash, signature);
    ...
    return (
      <div className={styles.container}>
        <main className={styles.main}>
          ...
          <p><a href="https://github.com/tinchoabbate/nft-minter-for-humans" target="_blank" rel="noreferrer">What is this site?</a></p>
        </main>
      </div>      
    )
  } 
